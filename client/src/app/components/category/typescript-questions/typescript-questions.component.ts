...
import { Subject, interval, noop } from 'rxjs';
...
@Component({
  standalone: true,
  selector: 'app-typescript-questions',
  templateUrl: './typescript-questions.component.html',
  styleUrls: ['./typescript-questions.component.scss'],
  imports: [RouterModule, CommonModule, MatRadioModule, MatIconModule],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class TypeScriptQuestionsComponent implements OnDestroy {
  ...
  typeScriptQuestions: Question[] | undefined;
  ...
  showTypeScriptQuestions(): void {
    this.http.get<Question[]>(this.baseApiUrl + 'question/get-by-feild-name/typescript').subscribe(
      {
        next: response => {
          if (response) {
            this.typeScriptQuestions = response;
