...
@Component({
  standalone: true,
  selector: 'app-vuejs-questions',
  templateUrl: './vuejs-questions.component.html',
  styleUrls: ['./vuejs-questions.component.scss'],
  imports: [RouterModule, CommonModule, MatRadioModule, MatIconModule],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class VuejsQuestionsComponent implements OnDestroy {
